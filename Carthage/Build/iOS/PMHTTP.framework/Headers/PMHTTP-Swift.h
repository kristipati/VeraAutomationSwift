...
*/
+ (NSDate * _Nullable)parsedDataHeaderFromResponse:(NSURLResponse * _Nonnull)response;
/**
...
*/
- (void)addMultipartWithData:(NSData * _Nonnull)data withName:(NSString * _Nonnull)name mimeType:(NSString * _Nullable)mimeType filename:(NSString * _Nullable)filename;
/**
  Specifies a named multipart body for this request.
...
*/
- (void)addMultipartWithText:(NSString * _Nonnull)text withName:(NSString * _Nonnull)name;
/**
...
*/
- (void)addMultipartBodyWith:(void (^ _Nonnull)(HTTPManagerUploadMultipart * _Nonnull))block;
- (nonnull instancetype)initWith__copyOfRequest:(HTTPManagerRequest * _Nonnull)request OBJC_DESIGNATED_INITIALIZER;
@end
